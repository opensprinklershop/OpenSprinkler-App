...
module.exports = function (config) {
	config.set({
		...
		files: [
			...
			{ pattern: 'www/vendor-js/vis-timeline-graph2d.min.js', included: true, watched: false},
			{ pattern: 'www/css/vis-timeline-graph2d.min.css', included: true, watched: false},
			...
			{ pattern: 'www/vendor-js/qrcode.min.js', included: true, watched: false },
